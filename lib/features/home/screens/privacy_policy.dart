      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              'Information We Collect',
              'We collect information to provide better services to both Pujaris and Users (Devotees):',
            ),
            ...
            _buildBulletPoint(
              'Verification documents (ID proof, certificates, etc.)',
            ),

            _buildSubSection('b) Booking & Transaction Data'),
            _buildBulletPoint(
              'Puja booking details (date, time, location, mode)',
            ),
            ...
            _buildBulletPoint(
              'Send notifications, reminders, and booking updates',
            ),
            _buildBulletPoint(
              'Verify user identity and ensure service authenticity',
            ),
            ...
            _buildBulletPoint(
              'With users (devotees) who book your puja (eg., your name, language, and contact)',
            ),
            _buildBulletPoint(
              'With service providers for OTP, payment, and verification',
            ),
            ...
            _buildBulletPoint(
              'Request account deletion or data removal by contacting support',
            ),
            const SizedBox(height: 16),
            ...
            _buildSection(
              'Cookies & Analytics',
              'We may use analytics tools or cookies to improve app performance and understand usage patterns.\nThis data is anonymous and does not identify you personally.',
            ),
            const SizedBox(height: 16),
            ...
            _buildSection(
              'Third-Party Services',
              'Our app may include third-party tools (like payment gateways, OTP services, or Google Maps).\nEach of these services follows its own privacy policy — we encourage you to review them.',
            ),
            const SizedBox(height: 16),
            ...
            Row(
              children: [
                const Icon(Icons.email, color: Color(0xFFE47F25), size: 16),
                const SizedBox(width: 8),
                const Text(
                  'support@pujaribookingapp.com',
                  style: TextStyle(fontSize: 14, color: Color(0xFFE47F25)),
                ),
              ],
            ),
            const SizedBox(height: 8),
            Row(
              children: [
                const Icon(Icons.phone, color: Color(0xFFE47F25), size: 16),
                const SizedBox(width: 8),
                const Text(
                  '+91 90000 00000',
                  style: TextStyle(fontSize: 14, color: Color(0xFFE47F25)),
